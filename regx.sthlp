...
{opth stosuf(string)} {opth sigout(string)} {opth sigkw(string)} {cmd:RCOEF} {cmd:SIGMAT} {cmd:REPORT} {cmd:DISPLAY} {cmd:CHISTORE}
...
{synopt: {cmd:ROTINTE}}Rotating interaction controls; using together with {opth rotctrl(string)} and {opth inte(string)}{p_end}
